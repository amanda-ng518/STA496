...
data_for_pmisvd <- rbind(table1, table2)
...
save(m_embeds_1500,file = "CUI+Phecode_1500dim.Rdata")
save(m_embeds_2000,file = "CUI+Phecode_2000dim.Rdata")
save(m_embeds_2500,file = "CUI+Phecode_2500dim.Rdata")
save(m_embeds_3000,file = "CUI+Phecode_3000dim.Rdata")
